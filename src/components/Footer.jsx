          ...
          <div className="lg:col-span-2">
            <div className="flex items-center space-x-2 mb-4">
              ...
              <div>
                ...
                <div className="text-sm text-gray-300">Premium SDR teams from South Africa</div>
              </div>
            </div>
            <p className="text-gray-300 mb-6 max-w-md">
              Boutique international sales outsourcing and consulting firm delivering measurable growth through strategic partnerships. Dashboard access, HubSpot integration and managed SDR seats.
            </p>
        ...
        <div className="border-t border-gray-700 mt-12 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            ...
            <div className="text-gray-300 text-sm text-center md:text-right max-w-md">
              <p className="mb-2">
                <strong>Legal Notice:</strong> All SDRs are classified as independent contractors. 
                Please consult with your local legal and tax advisors regarding contractor classification 
                and compliance requirements in your jurisdiction.
              </p>
              <p>
                We recommend seeking professional advice to ensure compliance with local employment laws.
              </p>
            </div>
          </div>
        </div>
